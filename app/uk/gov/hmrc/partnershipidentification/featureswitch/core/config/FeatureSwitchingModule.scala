...
package uk.gov.hmrc.partnershipidentification.featureswitch.core.config

import play.api.inject.{Binding, Module}
import play.api.{Configuration, Environment}
import uk.gov.hmrc.partnershipidentification.featureswitch.core.models.FeatureSwitch
