...
@Singleton
class JourneyDataService @Inject()(partnershipIdentificationRepository: JourneyDataRepository,
  ...
  def createJourney(authInternalId: String): Future[String] = {
    ...
    partnershipIdentificationRepository.createJourney(journeyId, authInternalId)
  }

  def getJourneyData(journeyId: String, authInternalId: String): Future[Option[JsObject]] = {
    partnershipIdentificationRepository.getJourneyData(journeyId, authInternalId)
  }

  def getJourneyDataByKey(journeyId: String, dataKey: String, authInternalId: String): Future[Option[JsValue]] = {
    partnershipIdentificationRepository.getJourneyData(journeyId, authInternalId).map {
  ...
  def updateJourneyData(journeyId: String, dataKey: String, data: JsValue, authInternalId: String): Future[Boolean] = {
    partnershipIdentificationRepository.updateJourneyData(journeyId, dataKey, data, authInternalId)
  }

  def removeJourneyDataField(journeyId: String, authInternalId: String, dataKey: String): Future[Boolean] = {
    partnershipIdentificationRepository.removeJourneyDataField(journeyId, authInternalId, dataKey)
  }
